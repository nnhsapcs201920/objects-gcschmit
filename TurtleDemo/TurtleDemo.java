...
public class TurtleDemo
{
    ...
    public static void  drawLine()
    {
         ...
         *          and they have the same type of properties (but they may have different values).
         *          
         ...
         *  
         *  Mutator methods modify the state (i.e., values of properties) of the object.
        ...
        /*
         * Accessor method returns the value of a property of the object.
