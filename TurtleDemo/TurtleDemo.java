...
public class TurtleDemo
{
    ...
    public static void drawLine()
    {
         ...
         * 
         * If we have to pass additional information  to construct the object, arguments  are
         ...
         * 
         * Mutator methods modify the state (i.e., values of its properties) of the object.
